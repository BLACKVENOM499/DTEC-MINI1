...
case 'setting': {
  try {
    ...
    if (senderNum !== sanitized && senderNum !== ownerNum) {
      return await socket.sendMessage(sender, { text: '❌ *ᴘᴇʀᴍɪꜱꜱɪᴏɴ ᴅᴇɴɪᴇᴅ.*' });
    }

    // Get current settings
    const currentConfig = await loadUserConfigFromMongo(sanitized) || {};
    const botName = currentConfig.botName || 'ᴅᴛᴇᴄ ᴍɪɴɪ';
    const prefix = currentConfig.PREFIX || config.PREFIX;
    const logo = currentConfig.logo || 'https://files.catbox.moe/ir37re.png';

    const stat = (val) => (val === 'true' || val === 'on' || val === 'online') ? '✅' : '❌';

    const text = `
⚙️ *${botName.toUpperCase()} ꜱᴇᴛᴛɪɴɢꜱ ᴘᴀɴᴇʟ* ⚙️
━━━━━━━━━━━━━━━━━━━━━━━━

👋 ʜᴇʟʟᴏ! ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴍᴀɴᴀɢᴇ ᴀʟʟ ʏᴏᴜʀ ʙᴏᴛ ꜱᴇᴛᴛɪɴɢꜱ ᴇᴀꜱɪʟʏ.
...
👁️ ꜱᴛᴀᴛᴜꜱ ꜱᴇᴇɴ: ${stat(currentConfig.AUTO_VIEW_STATUS)}

━━━━━━━━━━━━━━━━━━━━━━━━
> *ᴘොᴡᴇʀᴇᴅ ʙʏ ᴅᴛᴇᴄ ᴍɪɴɪ ꜱʏꜱᴛᴇම*
`.trim();

    // 🔘 සියලුම Settings ඇතුළත් කළ List/Section Buttons
    const sections = [
        {
            title: "📂 ᴡᴏʀᴋ ᴍᴏᴅᴇ ꜱᴇᴛᴛɪɴɢꜱ",
            rows: [
                { title: "ᴘᴜʙʟɪᴄ ᴍᴏᴅᴇ", rowId: `${prefix}wtype public`, description: "ꜱᴇᴛ ʙᴏᴛ ᴛᴏ ᴘᴜʙʟɪᴄ" },
                { title: "ᴘʀɪᴠᴀᴛᴇ ᴍᴏᴅᴇ", rowId: `${prefix}wtype private`, description: "ꜱᴇᴛ ʙᴏᴛ ᴛᴏ ᴘʀɪᴠᴀᴛᴇ" }
            ]
        },
        {
            title: "🤖 ᴀᴜᴛᴏᴍᴀᴛɪᴏɴ ꜱᴇᴛᴛɪɴɢꜱ",
            rows: [
                { title: "ᴀᴜᴛᴏ ᴛʏᴘɪɴɢ ᴏɴ", rowId: `${prefix}autotyping on` },
                { title: "ᴀᴜᴛᴏ ᴛʏᴘɪɴɢ ᴏꜰꜰ", rowId: `${prefix}autotyping off` },
                { title: "ᴀᴜᴛᴏ ʀᴇᴄᴏʀᴅɪɴɢ ᴏɴ", rowId: `${prefix}autorecording on` },
                { title: "ᴀᴜᴛᴏ ʀᴇᴄᴏʀᴅɪɴɢ ᴏꜰꜰ", rowId: `${prefix}autorecording off` }
            ]
        },
        {
            title: "📱 ꜱᴛᴀᴛᴜꜱ & ᴄᴀʟʟꜱ",
            rows: [
                { title: "ꜱᴛᴀᴛᴜꜱ ꜱᴇᴇɴ ᴏɴ", rowId: `${prefix}rstatus on` },
                { title: "ꜱᴛᴀᴛᴜꜱ ꜱᴇᴇɴ ᴏꜰꜰ", rowId: `${prefix}rstatus off` },
                { title: "ᴀɴᴛɪ-ᴄᴀʟʟ ᴏɴ", rowId: `${prefix}creject on` },
                { title: "ᴀɴᴛɪ-ᴄᴀʟʟ ᴏꜰꜰ", rowId: `${prefix}creject off` }
            ]
        }
    ];

    // 📤 Sending List Message (සෑම Setting එකක්ම Button එකක් ලෙස)
    await socket.sendMessage(sender, {
        image: { url: logo },
        caption: text,
        footer: "ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ᴛᴏ ꜱᴇᴇ ᴀʟʟ ᴏᴘᴛɪᴏɴꜱ",
        buttonText: "⚙️ ꜱᴇʟᴇᴄᴛ ꜱᴇᴛᴛɪɴɢ",
        sections,
        headerType: 4
    }, { quoted: msg });
