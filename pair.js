...
case 'chat': {
    try {
        ...
        const response = await axios.get(`https://www.movanest.xyz/v2/gemini?query=${encodeURIComponent(query)}`);
...
`.trim();
  ...
  const yts = require('yt-search');
  const axios = require('axios');
  const apikey = "5c39ebc56f164e7d8988a90c8b22f8b79139b3e9468fcd6f33e0944f41f8e57c";
  const apibase = "https://back.asitha.top/api";
